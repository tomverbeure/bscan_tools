...
ensure_lib                    ./libraries/jtag_uart_w8_r2048/
vmap       jtag_uart_w8_r2048 ./libraries/jtag_uart_w8_r2048/
...
alias com {
  ...
  vlog "$QSYS_SIMDIR/submodules/jtag_uart_jtag_uart_w8_r2048.v" -work jtag_uart_w8_r2048
...
alias elab {
  echo "\[exec\] elab"
  vsim -t ps -L work -L work_lib -L rst_controller -L jtag_uart_w8_r2048 -L jtag_uart_w32_r8 -L jtag_uart_w8_r64 -L jtag_uart_w16_r32 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L rst_controller -L jtag_uart_w8_r2048 -L jtag_uart_w32_r8 -L jtag_uart_w8_r64 -L jtag_uart_w16_r32 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
