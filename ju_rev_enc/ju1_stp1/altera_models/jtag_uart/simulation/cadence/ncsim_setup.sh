...
mkdir -p ./libraries/jtag_uart_w16_r8/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog "$QSYS_SIMDIR/submodules/jtag_uart_jtag_uart_w16_r8.v" -work jtag_uart_w16_r8 -cdslib ./cds_libs/jtag_uart_w16_r8.cds.lib
